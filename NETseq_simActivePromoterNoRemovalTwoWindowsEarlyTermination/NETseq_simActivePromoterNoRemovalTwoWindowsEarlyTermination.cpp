...
int main(int argc,char* argv[]){
  ...
  out_file<<"INIT\tELONG\tPAUSE1\tRESTART1\tPAUSE2\tRESTART2\tWINDOW_SIZE\tTERMINATION_SIZE\tNUM_INIT\tNUM_TERM\tNUM_FINISHED"<<endl;
  ...
  choose_intParam(sample_params[7],0,G,num_params);//Termination size (bp)
