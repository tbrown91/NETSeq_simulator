 void sim_polIITwoWindows(const double init,const double elong,const double pause1,const double restart1,const double backtrack1,const double restart_backtrack1,const double pause2,const double restart2,const double backtrack2,const double restart_backtrack2,const double window_size,vector<int>& movingStalledBacktrackedPolIIDist, vector<int>& movingStalledPolIIDist, vector<int>& movingPolIIDist,const int G,const int W,const int num_cells,double dt,const int num_timeSteps,int& num_init,int& num_term,int& num_finished){
