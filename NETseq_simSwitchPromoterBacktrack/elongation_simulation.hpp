 void sim_polII(const double act,const double inact,const double init,const double elong,const double pause,const double restart,const double backtrack,const double backtrack_restart, vector<int>& movingStalledBacktrackedPolIIDist, vector<int>& movingStalledPolIIDist, vector<int>& movingPolIIDist,const int G,const int W,const int num_cells,double dt,const int num_timeSteps,int& num_init,int& num_term,int& num_finished){
