...
int main(int argc,char* argv[]){
  ...
  out_file<<"INIT\tELONG\tPAUSE1\tRESTART1\tPAUSE2\tRESTART2\tTERM\tWINDOW_SIZE\tNUM_INIT\tNUM_TERM\tNUM_FINISHED"<<endl;
  ...
  choose_param(sample_params[6],0.001,1.0,num_params);//Termination probability(/min)
  choose_intParam(sample_params[7],0,G,num_params);//Window size (bp)
