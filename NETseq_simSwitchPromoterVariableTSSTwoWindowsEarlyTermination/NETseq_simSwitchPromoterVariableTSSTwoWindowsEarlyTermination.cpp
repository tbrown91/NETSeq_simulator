...
int main(int argc,char* argv[]){
  ...
  out_file<<"ACT\tINACT\tINIT\tELONG\tPAUSE1\tRESTART1\tPAUSE2\tRESTART2\tTSS_mu\tTSS_sigma\tWINDOW_SIZE\tTERMINATION_SIZE\tNUM_INIT\tNUM_TERM\tNUM_FINISHED"<<endl;
  ...
  choose_intParam(sample_params[11],0,G,num_params);//Termination window size(bp)
  ...
  for (int it=0;it<num_params;++it){
    ...
    sim_polIITwoWindows(sample_params[0][it],sample_params[1][it],sample_params[2][it],sample_params[3][it],sample_params[4][it],sample_params[5][it],sample_params[6][it],sample_params[7][it],sample_params[8][it],sample_params[9][it],sample_params[10][it],sample_params[11][it],NETseqDist,PROseqDist,G,W,num_cells,dt,num_timeSteps,num_init,num_term,num_finished);
