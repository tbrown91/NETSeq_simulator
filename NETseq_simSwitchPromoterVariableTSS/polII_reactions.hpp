...
void check_bind(vector<int>& polII_location,vector<int>& polII_status,int& promoter,const double act,const double inact,const double init,const double elong,const int TSS_mu,const double TSS_sigma,const int W,int& num_init,int& num_term,const int G){
