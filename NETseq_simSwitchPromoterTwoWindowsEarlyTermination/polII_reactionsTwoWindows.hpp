...
void check_bindTwoWindows(vector<int>& polII_location,vector<int>& polII_status,int& promoter,const double act,const double inact,const double init,const double elong,const int W,int& num_init,int& num_term){
  if (promoter==1){
